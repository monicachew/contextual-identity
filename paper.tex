...
survey contextual identity violations, suggest possible mitigations, and
propose new resesarch directions to empower users to have better control over their contextual identities.
\end{abstract}
...
privacy, but the act of sharing alone does not negate expectation of privacy~\cite{boyd2}.
...
\begin{verbatim}
NEED NEW EXAMPLE
gay teen joins facebook group
megan meier
amanda todd
tyler clementi
http://www.sync-blog.com/sync/2012/10/gay-students-outed-by-facebook-privacy-loophole.html
...
most people. A brief survey of social networking advice reveals that the major
causes of concern come not from a dedicated social graph expert, but people
...
to the user's Google Talk contacts, which includes everyone
with whom a user has chatted whether they be co-workers, supervisors, or
...
implicitly through browsing via techniques in Section~\ref{sec:tracking}.
...
\section{How do users think about identity?}
\subsection{Blushproof}
\subsection{Cookie statistics}
