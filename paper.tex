...
new service that they control other existing, credible identities.  The rise of
verified account mechanisms in Twitter, Google Plus and Facebook indicates that
...
bound to share personal information online that they regret~\cite{tamir}.
...
Facebook provide APIs for post deletion\footnote{Google Plus offers a read-only
API.}.
