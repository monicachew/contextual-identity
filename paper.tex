...
%\title{Contextual Identity: All your selves are belong to you}
...
interaction and sharing personal information. The act of
...
simple sharing of personal information itself, but rather from sharing that
information in a way that violates social norms~\cite{nissenbaum}.

For example, lesbian, gay, bisexual, and transgendered youth are particularly at risk for contextual
...
message is as important to its effect on a user as the contents.
...
we assert that people are concerned about their interactions with others close to
them.
...
Although additional access control and improved usability can improve contextual identity
management, they are not a panacea: many of the below examples fall out of
scope of traditional access control models.

\label{sec:examples}
\subsection{Redistributing information in a different context}
...
\subsection{Unaccommodating policies}
\label{sec:policies}
...
\subsection{Confusing user interfaces}
