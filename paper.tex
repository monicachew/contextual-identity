...
user identity, and works well for modeling privacy legislation and policy. Two
drawbacks of this work are that it is incapable of modeling information that is
about more than one person, and it is the type of information rather than the
content of the information that determines whether or not integrity is
violated. In the context of social networks, information is rarely ever about a
single person, and the tone of the message is as important to user
happiness as the content of the message.
